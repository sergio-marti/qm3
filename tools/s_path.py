...
x.get_func()
x.current_step( 0 )
#qm3.actions.paths.page_mciver( x, step_number = 1000, step_size = 0.01, print_frequency = 1, project_RT = False, avoid_recrossing = True )
qm3.actions.paths.page_mciver( x, step_number = 500, step_size = 0.01, print_frequency = 1, project_RT = False, avoid_recrossing = False )
