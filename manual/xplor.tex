...
If an empty molecule (molecule.natm = 0) is passed as an argument to \func{psf\_read} if will be filled from the contents of the PSF file (\parm{fname}) just missing the coordinates. This function also returns the list of bonds of the system.\\
