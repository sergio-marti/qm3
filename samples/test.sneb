...
nwin = 24
oneb = qm3.actions.neb.serial_neb( my_pes( reac ), [0, 1, 2], 1., qm3.actions.neb.distribute( nwin, [ reac, prod ] ) )
qm3.actions.minimize.fire( oneb, step_number = 200, gradient_tolerance = 0.001, step_size = 0.1, print_frequency = 1 )
