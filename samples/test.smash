...
class my_eng( qm3.problem.template ):
    ...
    def __init__( self ):
        ...
        f = io.StringIO( """
job qm3_job method=b3lyp basis=6-31g(d,p) memory=2GB
geom
qm3_atoms
""" )
        f.seek( 0 )
        self.eng = qm3.engines.smash.smash( self.mol, f, [ 0, 1, 2 ], [ 3, 4, 5 ] )
        self.eng.exe = "mpirun -n 2 ./bin/smash_mpi < smash.inp > smash.out"
