...
os.environ["QM3_LIBDFTB"] = "./dftb.so"
...
""" )
        f.seek( 0 )
#        self.eng = qm3.engines.dftb.dftb( self.mol, f, [ 0, 1, 2 ], [ 3, 4, 5 ] )
#        self.eng.exe = "./dftb+ > dftb_in.log"
        self.eng = qm3.engines.dftb.dl_dftb( self.mol, f, [ 0, 1, 2 ], [ 3, 4, 5 ] )
