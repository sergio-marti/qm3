...
""" )
        f.seek( 0 )
        self.eng = qm3.engines.lsdalton.lsdalton( self.mol, f, [ 0, 1, 2 ], [ 3, 4, 5 ] )
        self.eng.exe = "bash r.lsdalton"
        self.eng.bas = "def2_svp"
...
f = open( "r.lsdalton", "wt" )
f.write( """
cwd=./bin
mem=512
export WRKDIR=`pwd`
export BASDIR=$WRKDIR:$cwd/basis
export WRKMEM=`expr $mem "*" 128000`
export OMP_NUM_THREADS=4
$cwd/lsdalton.x > /dev/null
""" )
f.close()
